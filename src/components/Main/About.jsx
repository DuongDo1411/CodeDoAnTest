    ...
    <div className="row container">
      <div className="columns" data-aos="fade-right" data-aos-delay="300">
        ...
        <h4>
          <FormattedMessage
            id="description"
            defaultMessage="My name is Vu Le Thai Duong and I am a full stack developer."
          />
        </h4>
        <p>
          <FormattedMessage
            id="my-description"
            defaultMessage="I have been working on web designing and web development for 100 years. Constantly updating the technologies I already master, but also looking to learn new technologies to enrich my skills and improve my good practices as a developer."
          />
        </p>
        <ul>
          <li>
          ...
          <li>
            <p>
              ...
              Viet Nam , English , 日本語
            </p>
          </li>
          <li>
            <p>
              <span>Email:</span> duongdokimma@gmail.com
            </p>
          </li>
          <li>
            <p>
